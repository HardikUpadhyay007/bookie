export default function CommunityPage() {
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center justify-center px-6 py-16 rounded-2xl bg-neutral-900/80 shadow-2xl border border-neutral-800 max-w-lg mx-auto">
                <span className="text-primary text-5xl mb-6 animate-bounce">
                    📚
                </span>
