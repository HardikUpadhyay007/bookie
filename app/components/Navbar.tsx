...
import { Menu, Search, Heart } from "lucide-react"; // Add Heart here
            ...
            <div className="mx-auto flex w-full max-w-7xl items-center gap-6">
                ...
                >
                    ...
                    >
                        <rect
                            ...
                            height="30"
                            rx="15"
                            fill="#18181b" // Use a dark background for contrast
                        />
                        <path
                            ...
                            fill="#fff" // Use white for the icon
                        />
                    </svg>
                ...
                <form
                    ...
                    onSubmit={(e) => {
                        ...
                        setSearch(""); // Reset the search bar after searching
                    }}
                >
                    ...
                    {!isSignedIn ? (
                        ...
                        <>
                            <Button
                                ...
                                className="relative mx-2 p-2 rounded-full hover:bg-pink-600/20 transition-colors"
                            >
                                <Heart className="text-pink-500 w-6 h-6" />
                                {/* Example badge for liked count */}
                                {/* <span className="absolute -top-1 -right-1 bg-pink-500 text-white text-xs rounded-full px-1.5 py-0.5">3</span> */}
                            </Button>
